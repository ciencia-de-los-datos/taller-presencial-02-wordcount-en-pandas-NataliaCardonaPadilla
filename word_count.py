...
def load_input(input_directory):
    ...
    #    data_frames.append(pd.read_csv(filenames[0], sep="\t", header=None, names=["text"]))
    data_frames=[
...
def count_words(dataframe):
    ...
    # con value_counts omito la sulmas dos lineas comentadas, y esta función me ordena de mayor a menor
    return dataframe
